...
const itemVariants = cva(
  "group/item flex w-full flex-wrap items-center rounded-2xl border text-sm transition-colors duration-100 outline-none [a]:transition-colors [a]:hover:bg-muted",
  {
    variants: {
      variant: {
